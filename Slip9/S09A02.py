...
Question:
Write a Python program to solve the water jug problem. Two jugs with capacities 5 gallons
and 7 gallons are given with unlimited water supply. The target is to achieve 4 gallons of water
in the second jug.
